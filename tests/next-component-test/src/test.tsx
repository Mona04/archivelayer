export const EX = ()=>{
    return (
        <div>
          ...
          <p>Integer id libero consequat, varius massa ut, aliquet velit. Vestibulum consectetur accumsan ipsum, ut gravida est cursus nec. Aliquam erat volutpat. Nullam ultricies nisi vel tortor efficitur, nec ullamcorper arcu suscipit. Nulla ultrices justo et quam eleifend, vel consequat nisi lacinia. Donec euismod, magna a elementum vestibulum, dolor quam varius ligula, eget facilisis turpis justo id libero.</p>
        </div>
      );
}